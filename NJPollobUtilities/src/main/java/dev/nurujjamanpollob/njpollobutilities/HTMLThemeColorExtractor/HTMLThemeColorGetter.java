package dev.nurujjamanpollob.njpollobutilities.HTMLThemeColorExtractor;
...
public class HTMLThemeColorGetter
{
    ...
    private class SyncTask extends NJPollobCustomAsyncTask<Void, String>
    {
        ...
        {
            if(result.equals("") && onGetEvent != null){
                onGetEvent.onExceptionOccured("Generally a null pointer, nothing special!");
            }
