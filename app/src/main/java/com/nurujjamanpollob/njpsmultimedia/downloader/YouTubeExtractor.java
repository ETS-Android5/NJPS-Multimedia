...
public abstract class YouTubeExtractor extends AsyncTask<String, Void, SparseArray<YtFile>> {
    ...
    YouTubeExtractor(@NonNull Context con) {
    ...
    private SparseArray<YtFile> getStreamUrls() throws IOException, InterruptedException {
                ...
                try {
                    ...
                    while ((line = reader.readLine()) != null) {
                        if(line.startsWith("https://") || line.startsWith("http://")){
                            ...
                            if(mat.find()){
                                int itag = Integer.parseInt(Objects.requireNonNull(mat.group(1)));
        ...
        while (mat.find()) {
            ...
            int itag = Integer.parseInt(Objects.requireNonNull(mat2.group(1)));
    ...
    private boolean decipherSignature(final SparseArray<String> encSignatures) throws IOException {
        ...
        if (decipherFunctionName == null || decipherFunctions == null) {
            ...
            if (mat.find()) {
                ...
                assert decipherFunctionName != null;
    ...
    private void parseVideoMeta(String getVideoInfo) {
        ...
        if (mat.find()) {
            length = Long.parseLong(Objects.requireNonNull(mat.group(1)));
        }
        mat = patViewCount.matcher(getVideoInfo);
        if (mat.find()) {
            viewCount = Long.parseLong(Objects.requireNonNull(mat.group(1)));
        }
