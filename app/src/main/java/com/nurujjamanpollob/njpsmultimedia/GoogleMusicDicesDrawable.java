...
public class GoogleMusicDicesDrawable extends Drawable implements Drawable.Callback {
    ...
    private static final int DICE_SIDE_COLOR = Color.parseColor("#D38DEFE6");
    private static final int DICE_SIDE_SHADOW_COLOR = Color.parseColor("#D5FA6257");
    ...
    public static class Builder {
        public Builder(MainBrowser mainBrowser) {
        }
